...
class DataManager:
    def __init__(self, data, file_names):
        ...
        if self.data.size > 0:
            self.graph_manager.build_graph(self.data)
    ...
    def merge_lanes(self, lane_id_1, lane_id_2, point_1, point_2, point_1_type, point_2_type):
        ...
        #     lane_id_1, point_1, point_1_type, lane_id_2, point_2, point_2_type = (
        #         lane_id_2, point_2, point_2_type, lane_id_1, point_1, point_1_type)
        self.add_connection(point_1, point_2)
        pass

    def add_connection(self, point1_idx, point2_idx):
        self.graph_manager.add_edge(point1_idx, point2_idx)
        print(f"Added connection between point {point1_idx} and {point2_idx}")
